...
e5=tk.Entry(win,width=20, textvariable=eoutput)
...
def step2():
    ...
    b3.grid(row=2,column=2, columnspan=2)
    b4.grid(row=2,column=3, columnspan=2)
...
l6.grid(row=1,column=1, columnspan=2)
b1.grid(row=1,column=2, columnspan=2)
b2.grid(row=1,column=3, columnspan=2)
